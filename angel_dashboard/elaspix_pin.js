...
function createPin(settings) {
    ...
    var mImg;
    var mName;
    //var mTarget={"x":50,"y":50};// in px //replaced in this projecct by settins.pos
    ...
    function setup() {
        //mTarget.x=settings.pos.x;  //replaced in this projecct by settins.pos
    ...
    //in this project target is set externally by settings.pos
