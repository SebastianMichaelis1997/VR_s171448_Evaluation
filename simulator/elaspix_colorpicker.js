...
function createColorpicker(settings)
{
	...
	function setup()
	{
		...
		mColorButton1.wrapper.hover(function(){onHoverIn(mColorButton1.wrapper);},function(){onHoverOut(mColorButton1.wrapper);});
		mColorButton2.wrapper.on("click touchstart",onClickColorButton2);
		mColorButton2.wrapper.hover(function(){onHoverIn(mColorButton2.wrapper);},function(){onHoverOut(mColorButton2.wrapper);});
	...
	function setCSSColorItem(aItem,aColor)
	{
		...
		aItem.on("click touchstart",function(){onClickColorItem(aColor);});
	}
