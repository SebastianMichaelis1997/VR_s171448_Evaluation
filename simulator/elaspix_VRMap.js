...
function createVRMap(settings)
{
	...
	function addPin(aName,aX,aY)
	{
		//console.log("addPin for "+aName+" at ["+aX+","+aY+"]");
		
		if (mPins.hasOwnProperty(aName)==false)
		{
			var pin=createPin({"parent":mPinsDiv,"name":aName,"pos":{"x":aX,"y":aY},
	...
	{
		mImgMapWrap.fadeOut("slow",function(){mImgMapWrap.hide("slow");if (aFunction!=undefined){aFunction();} });				
	}
