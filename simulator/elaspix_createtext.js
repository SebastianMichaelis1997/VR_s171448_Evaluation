...
function createCreatetext(settings)
{
	...
	function inflate()
	{
		...
		mTextInput=createInputtext({"parent":settings.parentColumn1,"id":"createtext-input","width":"100%",
										  "labelText":"Texteingabe","inputPlaceholder":"Ihr Text","inputType":"text",
										  "hintText":"",
										  "onKeypress":onKeypress});
	
		
		mFontDropdown=createDropdowndesktop({"parent":mContainerFlex,"id":"createtext-font","labelText":"Schriftart",
